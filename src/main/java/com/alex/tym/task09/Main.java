...
import static com.alex.tym.task09.Books.*;
...
public class Main {
    public static void main(String[] args) {
        ...
        findAuthorBooks.setBooks(books.searchBookByAuthor(line));
        ...
        findBooksAfterYear.setBooks(books.searchBookByYear(year));
        ...
        books.comparePuplisherNames(books.getBooks());
        books.printBooks();
